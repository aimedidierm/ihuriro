...
class LawDashboardSetting extends StatefulWidget {
  const LawDashboardSetting({super.key});

  @override
  State<LawDashboardSetting> createState() => _LawDashboardSettingState();
}

class _LawDashboardSettingState extends State<LawDashboardSetting> {
  bool _loading = false;
  ...
  void updateDashboard(
    ...
    final response =
        await http.put(Uri.parse('$lawSettingsURL/$dashboardId'), headers: {
