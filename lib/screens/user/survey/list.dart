...
import 'package:ihuriro/screens/user/survey/create.dart';
import 'package:ihuriro/screens/user/survey/details.dart';
...
class ListSurvey extends StatefulWidget {
  const ListSurvey({super.key});

  @override
  State<ListSurvey> createState() => _ListSurveyState();
}
...
class _ListSurveyState extends State<ListSurvey> {
  ...
  Future<void> fetchData() async {
    ...
    final response = await http.get(Uri.parse(userSurveysURL), headers: {
